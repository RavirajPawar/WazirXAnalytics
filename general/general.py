...
def user():
    ...
    deposits_and_withdrawals_data = mongo.db.deposits_and_withdrawals.find({"user":session.get("email")}, {'_id': False})
...
def upload_file():
    ...
    try:
        ...
        return redirect(url_for(".user", error="Failed To Upload File"))
